...
public class BasePage {
    ...
    public static List<WebElement> getElements(Locator locator, Object... args) {
        By by = locator.get(args);
        return BaseTest.driver.findElements(by);
    }

    public static List<WebElement> getElements(WebElement webElement, Locator locator, Object... args) {
        By by = locator.get(args);
        return webElement.findElements(by);
    }

    protected WebElement getElement(WebElement element, Locator locator, Object... args) {
        By by = locator.get(args);
    ...
    protected String getElementText(String message, WebElement webElement, Locator locator, Object... args) {
        Reporter.log(message);
        return getElement(webElement, locator, args).getText();
    }
    ...
    public static void switchToWindow(String handler) {
        BaseTest.driver.navigate().to(handler);
    }
